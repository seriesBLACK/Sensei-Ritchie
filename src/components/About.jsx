  ...
  const people = [
    {
      ...
      image: "https://w0.peakpx.com/wallpaper/575/851/HD-wallpaper-sabito-demon-slayer-kimetsu-no-yaiba.jpg",
    },
    {
      id: 2,
      name: 'Sabito',
      designation: "Crusader",
      image: "https://i.pinimg.com/564x/86/61/fe/8661fe719cada10f515f6549019dfb00.jpg",
    },
  ];
  return (
    <div className="w-full h-full bg-slate-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10 font-medium">
          ...
          even though my physical body left a long time ago, But my soul will alwayes be here fighting for what is true.
        </p>
...
export const BackgroundBeams = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        "absolute z-0 h-full w-full inset-0 flex items-center justify-center pointer-events-none",
        className
      )}
    >
      <svg
