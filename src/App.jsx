...
export default function App() {
  ...
  return (
    ...
    <div className="">
      ...
      <div className="h-[50rem] w-full bg-gradient-to-b from-slate-950 to-blue-950 flex flex-col items-center justify-center gap-4">
        ...
        <textarea style={{ width: '58%', height: '60px', borderRadius: "3%", padding: "5px" }} name="Message" id="Message" rows="2" value={message} onChange={(e) => { setMessage(e.target.value) }} placeholder="Type your message here and your preferred way of communication "></textarea>
